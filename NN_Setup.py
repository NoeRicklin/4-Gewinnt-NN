...
def create_bot(bot_name):
    NN_file = open(os.path.dirname(__file__) + f'\\V1-1\\bot_parametersV1-1\\Bot{bot_name}.txt', "w")
    NN_file.close()
    NN_file = open(os.path.dirname(__file__) + f'\\V1-1\\bot_parametersV1-1\\Bot{bot_name}.txt', "a")
