...
def create_bot(bot_name):
    NN_file = open(os.path.dirname(__file__) + f'\\bot_parameters{version}\\Bot{bot_name}.txt', "w")
    NN_file.close()
    NN_file = open(os.path.dirname(__file__) + f'\\bot_parameters{version}\\Bot{bot_name}.txt', "a")
